...
//    const param = formatValue(item.pp2 ? item.pp2.value : item.pp1.value)+': '+ formatValue(item.oo2 ? item.oo2.value : item.oo1.value)
    const param = formatValue(item.pp3 ? item.pp3.value : (item.pp2 ? item.pp2.value : item.pp1.value))+': '+ formatValue(item.oo3 ? item.oo3.value : (item.oo2 ? item.oo2.value : item.oo1.value))
